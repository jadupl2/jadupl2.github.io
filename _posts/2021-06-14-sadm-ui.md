...
version:        2.2
summary: |         
    This is the SADMIN System Adminstration Menu.
    {: .text-justify}
updated:        2021-06-14
os:             Linux
...
$ sudo sadm
```
For the moment there are three items in the System ADMinistrator main menu, but others will be added. This tool is available from the terminal and is very simple to use.
