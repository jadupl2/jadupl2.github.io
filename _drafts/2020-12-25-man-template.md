...
| [sadm_server_sunrise.sh]({% post_url 2021-05-26-sadm-server-sunrise %})           | Collect & process data produced by all actives clients  
...
| [sadm_nmon_watcher.sh]({% post_url 2021-06-25-sadm-nmon-watcher %})               | Check if performance collector (nmon) is running, if it is not start it. |    